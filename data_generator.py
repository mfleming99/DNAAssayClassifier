...
def run_bowtie(bowtie_index, contents, frequency_tree):
    ...
    for i in range(len(contents)):
        ...
        print(bowtie_index)
        subprocess.call(["/software/bowtie2/bowtie2-align-s", "-x", str(bowtie_index), "--sra-acc", contents[i][0], "-sample-sra", str(reads_to_be_analized) , "--treads", "4", ">>", "/root/temp.sam"], shell=True)
